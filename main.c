...
TCHAR szClassName[ ] = _T("GESTION COVID_19");
  ...
  //  char * nom1="personnesInfectees.txt",* nom2="Maladies.txt";
    ...
    switch (message)                 /* handle the messages */
    {
        ...
        case 2:
                ...
                l=NULL;
                l=charger_Personnes("personnesInfectees.txt","Maladies.txt");
    ...
    case WM_CREATE :
        addmenus(hwnd);
            hBmp=LoadImage(NULL,"image3.bmp",IMAGE_BITMAP,800,500,LR_LOADFROMFILE);
...
void addmenus(HWND hwnd)
{
    ...
    AppendMenu(htp1,MF_STRING,6,"4-Modification Decés");
...
AppendMenu(hmenu,MF_POPUP,(UINT_PTR)htp11,"RECHERCHE PERSONNE ");
    ...
    AppendMenu(htp11,MF_STRING,8,"1-Par nationalité");
